...
const Login = () => {
  ...
  const handleValidateCaptcha = (event: React.FocusEvent<HTMLInputElement>) => {
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-10 border border-white/20">
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <div className="text-right">
                <Link to="/forgot-password" className="text-yellow-400 hover:text-yellow-300 font-medium transition-all duration-300 hover:underline">
                  Forgot password?
                </Link>
              </div>
